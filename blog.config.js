...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || 'be1e22c687994c7bbfeb6b787384015e',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Stay Foolish', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://home.xmelon.cafe', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Note,Life', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mail@12185744@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Dreamin121', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://dl.lancdn.com/landian/dev/high/src/high.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,twitter,telegram', // 分享的服務，按顺序显示,逗号隔开
  ...
  COMMENT_UTTERRANCES_REPO:
      process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'Dreamin121/comment-Utterance', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://com.xmelon.cafe/', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '小瓜田记', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || 'Stay hungry，Stay foolish', // 站点描述，被notion中的页面描述覆盖
