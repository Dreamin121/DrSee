...
const BLOG = {
  ...
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || menu, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dreamin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Stay Foolish', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xmelon.cafe', // 网站地址
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,twitter,telegram,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
